...
var Sliderman = new function(){
	...
	Sliderman.slider = function(parameters){
		...
		if(description && !contentmode){
			...
			var descriptionStl = {position: 'absolute', overflow: 'hidden', textAlign: 'center', color:'white', face:'arial'};
